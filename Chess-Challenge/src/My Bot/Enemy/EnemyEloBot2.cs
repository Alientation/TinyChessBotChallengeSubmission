...
/*
    Negamax + AB pruning + Quisence searching, iterative deepening, PST table for board eval, Transposition tables for eval cache,
*/
public class EnemyEloBot2 : IChessBot
{
